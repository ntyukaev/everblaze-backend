    ...
    'schemas' => [
        'default' => [
            'query' => [
                ...
                'cells' => App\GraphQL\Queries\CellsQuery::class,
                'chart' => App\GraphQL\Queries\ChartQuery::class,
                'charts' => App\GraphQL\Queries\ChartsQuery::class,
                'field' => App\GraphQL\Queries\FieldQuery::class,
                'fields' => App\GraphQL\Queries\FieldsQuery::class,
                'sheet' => App\GraphQL\Queries\SheetQuery::class,
                'sheets' => App\GraphQL\Queries\SheetsQuery::class,
                'column' => App\GraphQL\Queries\ColumnQuery::class,
                'columns' => App\GraphQL\Queries\ColumnsQuery::class,
                'report' => App\GraphQL\Queries\ReportQuery::class,
                'reports' => App\GraphQL\Queries\ReportsQuery::class,
                'dataset' => App\GraphQL\Queries\DatasetQuery::class,
                'datasets' => App\GraphQL\Queries\DatasetsQuery::class
            ],
            'mutation' => [
            ...
            'types' => [
                ...
                'Sheet' => App\GraphQL\Types\SheetType::class,
                'Report' => App\GraphQL\Types\ReportType::class,
                'Column' => App\GraphQL\Types\ColumnType::class,
                'Dataset' => App\GraphQL\Types\DatasetType::class,
                'DynamicType' => App\GraphQL\Scalars\DynamicType::class
            ],
